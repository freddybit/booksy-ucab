...
### app/router/ y app/views/

- Propósito: `app/router` centraliza la definición de rutas y `app/views` contiene las pantallas a nivel de página.

- Responsabilidad: Mantienen la navegación declarativa, permiten lazy-loading si es necesario y coordinan vistas con sus componentes y servicios asociados.
